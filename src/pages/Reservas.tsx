...
export default function Reservations() {
  const [reservations, setReservations] = useState<Booking[]>(bookingService.getAll())
  const [editingId, setEditingId] = useState<number | null>(null)
  const [editDate, setEditDate] = useState('')

  function handleDelete(id: number) {
    bookingService.delete(id)
    setReservations(bookingService.getAll())
  }
  ...
  function handleEditSave(id: number) {
    bookingService.update(id, { travelDate: editDate })
    setReservations(bookingService.getAll())
    setEditingId(null)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-950 px-6 py-20">
      <div className="max-w-5xl mx-auto">
        ...
        <h1 className="text-white text-4xl font-bold tracking-tight mb-16">
          Reservas
        </h1>
